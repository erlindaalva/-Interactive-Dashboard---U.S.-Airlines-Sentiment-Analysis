...
st.sidebar.markdown("This application is a Dashboard")

DATA_URL = ("C:/Users/user/projects/Dashboard_Twitter_US_Airline_Sentiment/Tweets.csv")
...
if not st.sidebar.checkbox("Close", True, key='2'):  #aquí la key era 1 ver porqué salía error
...
if not st.sidebar.checkbox("Close", True, key='3'):
    ...
    # Si no quieres problemas con fuentes, NO pongas font_path
    wordcloud = WordCloud(
        stopwords=STOPWORDS,
